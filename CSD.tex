...
Our solver-based one (cf.~Section~\ref{sec:csd:approach:smt}), our two baselines (cf.~Section~\ref{sec:csd:approach:baselines}), and three heuristic search methods from related work (cf.~Section~\ref{sec:csd:fundamentals:subgroup-discovery}).
