...
\begin{table}[t]
	...
	\begin{subtable}{\textwidth}
		...
		\begin{tabular}{lrrr}
			...
			\midrule
			BI & 34.95~s & 103.61~s & 2.60~s \\
			BSD & 55.70~s & 151.46~s & 1.06~s \\
			Beam & 30.47~s & 85.69~s & 2.95~s \\
			MORS & 0.01~s & 0.00~s & 0.01~s \\
			PRIM & 1.26~s & 1.51~s & 0.66~s \\
			Random & 0.91~s & 0.95~s & 0.51~s \\
			SD-Map & 367.43~s & 1143.05~s & 4.08~s \\
			SMT & 849.02~s & 929.60~s & 254.21~s \\
			\bottomrule
		\end{tabular}
		\caption{
			All 27 datasets.
	...
	\begin{subtable}{\textwidth}
		...
		\begin{tabular}{lrrr}
			...
			Method & Mean & Standard dev. & Median \\
			\midrule
			BI & 12.40~s & 21.17~s & 2.60~s \\
			BSD & 44.02~s & 128.33~s & 1.57~s \\
			Beam & 11.77~s & 20.47~s & 2.95~s \\
			MORS & 0.01~s & 0.00~s & 0.01~s \\
			PRIM & 1.29~s & 1.62~s & 0.80~s \\
			Random & 0.82~s & 0.89~s & 0.56~s \\
			SD-Map & 109.92~s & 290.69~s & 12.56~s \\
			SMT & 168.13~s & 243.11~s & 57.23~s \\
			\bottomrule
		\end{tabular}
		\caption{
...
\begin{table}[t]
	...
	\begin{tabular}{lrrrrrr}
		...
		$k$ & 1 & 2 & 3 & 4 & 5 & no \\
		\midrule
		BI & 7.8~s & 11.7~s & 14.2~s & 16.7~s & 18.7~s & 35.0~s \\
		BSD & 0.9~s & 0.9~s & 0.9~s & 2.7~s & 29.5~s & 55.7~s \\
		Beam & 6.8~s & 10.1~s & 12.8~s & 14.6~s & 16.1~s & 30.5~s \\
		MORS & 0.0~s & 0.0~s & 0.0~s & 0.0~s & 0.0~s & 0.0~s \\
		PRIM & 0.1~s & 0.2~s & 0.3~s & 0.3~s & 0.5~s & 1.3~s \\
		Random & 0.6~s & 0.6~s & 0.6~s & 0.7~s & 0.7~s & 0.9~s \\
		SD-Map & 2.3~s & 3.3~s & 9.6~s & 54.0~s & 345.2~s & 367.4~s \\
		SMT & 648.2~s & 911.3~s & 1091.7~s & 1113.4~s & 1117.4~s & 849.0~s \\
		\bottomrule
	\end{tabular}
	\caption{
