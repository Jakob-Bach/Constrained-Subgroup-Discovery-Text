...
Appendix~\ref{sec:csd:appendix:competitor-runtime} summarizes the runtime experiments with subgroup-discovery libraries that led to integrating \emph{BSD} and \emph{SD-Map} into the main experiments (cf.~Section~\ref{sec:csd:evaluation}).
