...
Further, if only certain features are permissible, as we discuss later, we reset the bounds of the remaining features (Line~\ref{al:csd:mors:line:reset-start}-\ref{al:csd:mors:line:reset-end}).
