...
While the former two are exhaustive, they require discretizing numeric features.
...
Additionally, heuristic solutions were less prone to overfitting than optimal solutions from exhaustive search.
...
For most subgroup-discovery methods, subgroups with as few as $k=2$ features in their description often yielded already a similar quality as unconstrained subgroups, i.e., using all features.
Further, feature-cardinality constraints reduced overfitting and sped up the heuristic search methods as well as \emph{BSD} and \emph{SD-Map}.
