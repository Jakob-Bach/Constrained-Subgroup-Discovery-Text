...
In this article, we focus on binary-classification tasks in our formalization and evaluation.
...
as alternative to prescribing k, can also eliminate irrelevant variables after having found box \cite{friedman1999bump}
